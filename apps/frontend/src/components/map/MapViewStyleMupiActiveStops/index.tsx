...
export const MapViewStyleMupiActiveStopsPrimaryLayerId = 'default-layer-active-stops-circle';
export const MapViewStyleMupiActiveStopsInteractiveLayerId = '';
...
export function MapViewStyleMupiActiveStops({ presentBeforeId, stopsData = baseGeoJsonFeatureCollection }: Props) {
	return (
