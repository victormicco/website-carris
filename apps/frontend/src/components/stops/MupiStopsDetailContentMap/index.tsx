...
import { MapViewStyleMupiActiveStops, MapViewStyleMupiActiveStopsPrimaryLayerId } from '@/components/map/MapViewStyleMupiActiveStops';
...
export function MupiStopsDetailContentMap() {
	//
	...
	function handleLayerClick(event) {
		...
		for (const feature of features) {
			...
			else if (feature.layer.id !== MapViewStyleMupiStopsInteractiveLayerId) {
				continue;
			}
			else {
